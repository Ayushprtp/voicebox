...
1. **Check GitHub Issues:** [github.com/Ayushprtp/voicebox/issues](https://github.com/Ayushprtp/voicebox/issues)
2. **Open a New Issue:** Provide:
   - Operating system and version
   - VoiceBox version
   - Steps to reproduce
   - Error messages or logs
3. **Get Support:** [github.com/Ayushprtp/voicebox/issues](https://github.com/Ayushprtp/voicebox/issues) (coming soon)
