...
<Tabs items={["Apple Silicon", "Intel"]}>
  <Tab value="Apple Silicon">
    Download: [voicebox_aarch64.app.tar.gz](https://github.com/Ayushprtp/voicebox/releases/latest/download/voicebox_aarch64.app.tar.gz)
  ...
  <Tab value="Intel">
    Download: [voicebox_x64.app.tar.gz](https://github.com/Ayushprtp/voicebox/releases/latest/download/voicebox_x64.app.tar.gz)
...
<Tabs items={["MSI Installer", "Setup Executable"]}>
  <Tab value="MSI Installer">
    Download: [voicebox_x64_en-US.msi](https://github.com/Ayushprtp/voicebox/releases/latest/download/voicebox_x64_en-US.msi)

    Double-click the MSI file and follow the installation wizard.
  </Tab>
  <Tab value="Setup Executable">
    Download: [voicebox_x64-setup.exe](https://github.com/Ayushprtp/voicebox/releases/latest/download/voicebox_x64-setup.exe)
